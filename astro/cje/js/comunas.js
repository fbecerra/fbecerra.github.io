        ...
        regions.forEach(reg => {
            ...
            if (reg !== 'TODAS') {
                ...
                d3.select("body").append("span")
                    .html(`La comuna de ${reg} tiene una repitencia de ${regionValue}%, lo que esta ${diff === 0 ? "justo en el" : Math.abs(diff).toFixed(2) + '%'} 
    ...
    const plotTerritoryIndicator = (data, reg, cols, promNacional) =>{
        ...
        cols.forEach(col => {
            ...
            if (!col.endsWith('tot')) {
                ...
                d3.select("body").append("span")
                    .html(`La comuna de ${reg} y filtro ${col} tiene una repitencia de ${regionValue}%, lo que esta ${diffRegional === 0 ? "justo en el" : Math.abs(diffRegional).toFixed(2) + '%'} 
